...
//
//	mockgen -destination=./internal/scheduler/mocks/api.go -package=schedulermocks github.com/armadaproject/armada/pkg/api SubmitClient,Submit_GetQueuesClient
//
