...
// High-level categorization of job run failures for retry policy evaluation.
type FailureCondition int32

const (
	FailureCondition_FAILURE_CONDITION_UNSPECIFIED FailureCondition = 0
	// Pod was preempted by Kubernetes or Armada scheduler.
	FailureCondition_FAILURE_CONDITION_PREEMPTED FailureCondition = 1
	// Pod was evicted from node (e.g., due to node pressure).
	FailureCondition_FAILURE_CONDITION_EVICTED FailureCondition = 2
	// Container was killed due to exceeding memory limits.
	FailureCondition_FAILURE_CONDITION_OOM_KILLED FailureCondition = 3
	// Pod exceeded its activeDeadlineSeconds.
	FailureCondition_FAILURE_CONDITION_DEADLINE_EXCEEDED FailureCondition = 4
	// Pod could not be scheduled to any node.
	FailureCondition_FAILURE_CONDITION_UNSCHEDULABLE FailureCondition = 5
	// User code exited with non-zero exit code.
	FailureCondition_FAILURE_CONDITION_USER_ERROR FailureCondition = 6
)

var FailureCondition_name = map[int32]string{
	0: "FAILURE_CONDITION_UNSPECIFIED",
	1: "FAILURE_CONDITION_PREEMPTED",
	2: "FAILURE_CONDITION_EVICTED",
	3: "FAILURE_CONDITION_OOM_KILLED",
	4: "FAILURE_CONDITION_DEADLINE_EXCEEDED",
	5: "FAILURE_CONDITION_UNSCHEDULABLE",
	6: "FAILURE_CONDITION_USER_ERROR",
}

var FailureCondition_value = map[string]int32{
	"FAILURE_CONDITION_UNSPECIFIED":       0,
	"FAILURE_CONDITION_PREEMPTED":         1,
	"FAILURE_CONDITION_EVICTED":           2,
	"FAILURE_CONDITION_OOM_KILLED":        3,
	"FAILURE_CONDITION_DEADLINE_EXCEEDED": 4,
	"FAILURE_CONDITION_UNSCHEDULABLE":     5,
	"FAILURE_CONDITION_USER_ERROR":        6,
}

func (x FailureCondition) String() string {
	return proto.EnumName(FailureCondition_name, int32(x))
}

func (FailureCondition) EnumDescriptor() ([]byte, []int) {
...
type JobRunLeased struct {
	...
	RunIndex uint32 `protobuf:"varint,13,opt,name=run_index,json=runIndex,proto3" json:"runIndex,omitempty"`
}
...
func (m *JobRunLeased) GetRunIndex() uint32 {
	if m != nil {
		return m.RunIndex
	}
	return 0
...
type Error struct {
	...
	//	*Error_JobRejected
	//	*Error_ReconciliationError
	Reason isError_Reason `protobuf_oneof:"reason"`
	// Structured failure information for retry policy evaluation.
	// Populated by the executor when reporting job run failures.
	FailureInfo *FailureInfo `protobuf:"bytes,15,opt,name=failure_info,json=failureInfo,proto3" json:"failureInfo,omitempty"`
}
...
type Error_ReconciliationError struct {
	ReconciliationError *ReconciliationError `protobuf:"bytes,14,opt,name=reconciliationError,proto3,oneof" json:"reconciliationError,omitempty"`
}
...
func (*Error_ReconciliationError) isError_Reason()  {}
...
func (m *Error) GetReconciliationError() *ReconciliationError {
	if x, ok := m.GetReason().(*Error_ReconciliationError); ok {
		return x.ReconciliationError
	}
	return nil
}
...
func (m *ReconciliationError) Reset()         { *m = ReconciliationError{} }
func (m *ReconciliationError) String() string { return proto.CompactTextString(m) }
func (*ReconciliationError) ProtoMessage()    {}
func (*ReconciliationError) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{39}
}
func (m *ReconciliationError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReconciliationError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReconciliationError.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReconciliationError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReconciliationError.Merge(m, src)
}
func (m *ReconciliationError) XXX_Size() int {
	return m.Size()
}
func (m *ReconciliationError) XXX_DiscardUnknown() {
	xxx_messageInfo_ReconciliationError.DiscardUnknown(m)
}

var xxx_messageInfo_ReconciliationError proto.InternalMessageInfo

func (m *ReconciliationError) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
// Structured failure information for retry policy evaluation.
// Extracted by the executor and sent to the scheduler with JobRunErrors.
type FailureInfo struct {
	// Exit code from the first failed container, if applicable.
	// A value of 0 means no exit code is available (proto3 default).
	ExitCode int32 `protobuf:"varint,1,opt,name=exit_code,json=exitCode,proto3" json:"exitCode,omitempty"`
	// High-level failure categorization.
	Condition FailureCondition `protobuf:"varint,2,opt,name=condition,proto3,enum=armadaevents.FailureCondition" json:"condition,omitempty"`
	// Pod check's original retry decision (for backward compatibility).
	// When retry policy is disabled, this determines retry behavior.
	PodCheckRetryable bool `protobuf:"varint,3,opt,name=pod_check_retryable,json=podCheckRetryable,proto3" json:"podCheckRetryable,omitempty"`
	// Message from pod check explaining the failure.
	PodCheckMessage string `protobuf:"bytes,4,opt,name=pod_check_message,json=podCheckMessage,proto3" json:"podCheckMessage,omitempty"`
	// Termination message from the first failed container.
	// This is the content written to /dev/termination-log or container output.
	TerminationMessage string `protobuf:"bytes,5,opt,name=termination_message,json=terminationMessage,proto3" json:"terminationMessage,omitempty"`
}
...
func (m *FailureInfo) GetExitCode() int32 {
	if m != nil {
		return m.ExitCode
	}
	return 0
...
func (m *FailureInfo) GetCondition() FailureCondition {
	if m != nil {
		return m.Condition
	}
	return FailureCondition_FAILURE_CONDITION_UNSPECIFIED
}

func (m *FailureInfo) GetPodCheckRetryable() bool {
	if m != nil {
		return m.PodCheckRetryable
	}
	return false
}

func (m *FailureInfo) GetPodCheckMessage() string {
	if m != nil {
		return m.PodCheckMessage
	}
	return ""
}

func (m *FailureInfo) GetTerminationMessage() string {
	if m != nil {
		return m.TerminationMessage
	}
	return ""
}
...
func (*JobRunCancelled) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{46}
}
...
func init() {
	...
	proto.RegisterEnum("armadaevents.FailureCondition", FailureCondition_name, FailureCondition_value)
	...
	proto.RegisterType((*ReconciliationError)(nil), "armadaevents.ReconciliationError")
	proto.RegisterType((*FailureInfo)(nil), "armadaevents.FailureInfo")
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	,
}
...
func (m *JobRunLeased) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RunIndex != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.RunIndex))
		i--
		dAtA[i] = 0x68
	}
	if len(m.Pool) > 0 {
...
func (m *Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FailureInfo != nil {
		{
			size, err := m.FailureInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Error_ReconciliationError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Error_ReconciliationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ReconciliationError != nil {
		{
			size, err := m.ReconciliationError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ReconciliationError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReconciliationError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReconciliationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FailureInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FailureInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FailureInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TerminationMessage) > 0 {
		i -= len(m.TerminationMessage)
		copy(dAtA[i:], m.TerminationMessage)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.TerminationMessage)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.PodCheckMessage) > 0 {
		i -= len(m.PodCheckMessage)
		copy(dAtA[i:], m.PodCheckMessage)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.PodCheckMessage)))
		i--
		dAtA[i] = 0x22
	}
	if m.PodCheckRetryable {
		i--
		if m.PodCheckRetryable {
			dAtA[i] = 1
		} else {
	...
	if m.Condition != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.Condition))
		i--
		dAtA[i] = 0x10
	}
	if m.ExitCode != 0 {
...
func (m *JobRunLeased) Size() (n int) {
	...
	if m.RunIndex != 0 {
		n += 1 + sovEvents(uint64(m.RunIndex))
	}
	return n
}
...
func (m *Error_ReconciliationError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReconciliationError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FailureInfo) Size() (n int) {
	...
	if m.Condition != 0 {
		n += 1 + sovEvents(uint64(m.Condition))
	}
	if m.PodCheckRetryable {
		n += 2
	}
	l = len(m.PodCheckMessage)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
	}
	l = len(m.TerminationMessage)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
	}
	return n
...
func (m *JobRunLeased) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RunIndex", wireType)
			}
			m.RunIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RunIndex |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReconciliationError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &ReconciliationError{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Reason = &Error_ReconciliationError{v}
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FailureInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FailureInfo == nil {
				m.FailureInfo = &FailureInfo{}
			}
			if err := m.FailureInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ReconciliationError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReconciliationError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReconciliationError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *FailureInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FailureInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FailureInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Condition |= FailureCondition(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PodCheckRetryable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PodCheckRetryable = bool(v != 0)
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PodCheckMessage", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PodCheckMessage = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TerminationMessage", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TerminationMessage = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
